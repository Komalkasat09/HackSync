      ...
      <div className="inner-container">
        ...
        <div className="header">
          <div className="header-content">
            ...
            {data.personal.title && <div className="tagline">{data.personal.title}</div>}
            ...
            <div className="timeline">
              {data.experience.map((job, idx) => (
                <div key={idx} className="timeline-item">
                  ...
                  <div className="item-subtitle">{job.company} • {job.location}</div>
                  <div className="item-dates">{job.startDate} - {job.endDate}</div>
                  <ul>
